...
from ...dbrefresh import refresh_contracts_database


class Command(BaseCommand):

    help = "Populate Database using json_data/JobsData_PreviousExecution.json file or the new 3-file system"
    ...
    def handle(self, *args, **kwargs):
        refresh_contracts_database(*args, **kwargs)
